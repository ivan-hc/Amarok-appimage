...
DEPENDENCES="ca-certificates dbus udisks2-qt5 kio5 kded5 kservice5 nss-mdns qt5-quickcontrols phonon-qt5-gstreamer phonon-qt5 gst-plugins-bad gst-plugins-good gst-plugins-ugly gst-libav"
...
LIBSAVED="pk p11 alsa jack pipewire pulse libGLX libampache_account_login libgtk-3 Xcursor $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
